...
const EVENT_DATE = new Date("2026-05-03T14:00:00");

export function CountdownMalaga() {
  ...
  const items = [
    { label: "Días", value: time.d, color: "bg-malaga-warm" },
    { label: "Horas", value: time.h, color: "bg-malaga-sunset" },
    { label: "Min", value: time.m, color: "bg-malaga-gold" },
    { label: "Seg", value: time.s, color: "bg-malaga-warm" },
  ];
