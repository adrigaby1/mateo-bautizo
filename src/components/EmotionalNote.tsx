export function EmotionalNote({ lang = "es" }: { lang?: "es" | "en" }) {
  const t = {
    title: lang === "en"
      ? "A very special day for our family"
      : "Un día muy especial para nuestra familia",
    body: lang === "en"
      ? "Thank you for joining us on such an important moment for Mateo. It would mean the world to share this special day with you."
      : "Gracias por acompañarnos en un momento tan importante para Mateo. Nos hará muchísima ilusión compartir este día tan especial con vosotros.",
  };
  return (
