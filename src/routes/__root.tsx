...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Domingo 5 de julio de 2026 · Marbella, frente al Mediterráneo" },
      { name: "twitter:description", content: "Domingo 5 de julio de 2026 · Marbella, frente al Mediterráneo" },
